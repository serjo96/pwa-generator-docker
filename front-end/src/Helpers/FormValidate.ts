export const requireField = (value: string ) => !!value || 'Require Field.';
export const emailRequired = (value: string ) => !!value || 'Require E-mail.';
...
export const validEmailRequired =  (value: string ) => /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/.test(value) || 'E-mail must be valid';
